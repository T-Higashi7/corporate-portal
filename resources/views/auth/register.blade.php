            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="loginid" class="col-md-4 col-form-label text-md-right">{{ __('messages.LoginID') }}</label>

                            <div class="col-md-6">
                                <input id="loginid" type="loginid" class="form-control @error('loginid') is-invalid @enderror" name="loginid" value="{{ old('loginid') }}" required autocomplete="loginid">
